...
public class PIMManager {
	...
	PIMBaseCollection bc;
		...
		try {
		    ...
		    // Since May. 16, 2017, my server was restructed, and added the SSL certificate.
		    // So old `http://pim.qinka.pro' was stopped, and was moved to my api server.
		    url = "https://api.qinka.pro/pim";
		}
		...
		try {
		    ...
		    // Since May 16, 2017, my server was restructed, and added the SSL certificate.
		    // The domain `pim.qinka.pro' was stopped.
		    // And `api.qinak.pro' is available now.
		    url = "jdbc:postgresql://api.qinka.pro:54321/postgres";
		}
		try {
		    user = args[2];
		}
		...
		try {
		    ...
		    // The important information here is that such a file, named `.ignore/data'
		    // need to create before launch this programme, using `make fix-1'
