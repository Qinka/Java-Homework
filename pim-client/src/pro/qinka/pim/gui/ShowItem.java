...
public class ShowItem extends JDialog {
	...
	//======== dialogPane ========
	{
	    ...
	    dialogPane.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EmptyBorder(0, 0, 0, 0),
		...
		//---- contextType ----
		contextType.setText("text");
		contextType.setHorizontalAlignment(SwingConstants.CENTER);
		contentPanel.add(contextType, "cell 0 0 2 1");
		...
		//====== context =======
		{
			...
			contextInfo.get("priorityC").setText(a.getPropertyName());
